...
export default () => {
  return (
    <div>
      ...
      <div className="onestop">
        ...
        <div className="onestop-body">
          ...
          <div className="container2">
            ...
            <h2>Blockchain<br></br>Infrastructure</h2>
          </div>
      ...
      <div className="about-head">Home</div>
      <div className="about-body">
        <p>
          บริการให้คำปรึกษาในการสร้าง Project เกี่ยวกับ Cryptocurrency
          แบบ One-stop-sevice ตั้งแต่เริ่มต้นไปจนจบโครงการ
        </p>
